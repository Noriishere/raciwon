...
<template x-teleport="body">
    ...
    <div x-show="openDeleteUser" x-cloak class="fixed inset-0 z-[99999] flex items-center justify-center p-4"
        x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0"
        x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-150"
        x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">

        {{-- Backdrop --}}
        <div @click="openDeleteUser = false" class="absolute inset-0 bg-slate-900/60 backdrop-blur-md">
        </div>
        ...
        <div @click.stop class="relative w-full max-w-[360px] bg-white rounded-3xl shadow-2xl overflow-hidden"
            ...
            <div class="px-5 pb-5">
                ...
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <button type="button" @click="openDeleteUser = false"
