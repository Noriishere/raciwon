...
<template x-teleport="body">
    ...
    <div x-show="openEditUser" x-cloak class="fixed inset-0 z-[99999] flex items-center justify-center p-4 sm:p-6"
        x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0"
        x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-150"
        x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">

        {{-- Backdrop --}}
        <div @click="openEditUser = false" class="absolute inset-0 bg-slate-900/60 backdrop-blur-md">
        </div>
        ...
        <div @click.stop class="relative w-full
            ...
            <div class="bg-gradient-to-r from-brand-600 to-brand-500 px-6 sm:px-8 py-6 text-white">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <button @click="openEditUser = false"
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <div class="space-y-5">
                            ...
                            <div>
                                ...
                                <input type="email" value="nori@raciwon.com"
                                    class="w-full rounded-xl border border-slate-200 px-4 py-3">
                            ...
                            <div class="rounded-2xl border border-amber-200 bg-amber-50 p-4">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <i class="fa-solid fa-key text-amber-600">
                                    </i>
                            ...
                            <div class="p-5">
                                ...
                                <div class="mt-5 rounded-2xl border border-blue-200 bg-blue-50 p-4">
                                    ...
                                    <div class="flex gap-3">
                                        ...
                                        <i class="fa-solid fa-pen text-blue-600 mt-0.5">
                                        </i>

                                        <p class="text-xs text-blue-700">

                                            Perubahan akan langsung memperbarui hak akses dan data pengguna.
            ...
            <div class="px-6 sm:px-8 py-4 bg-slate-50 border-t flex flex-col-reverse sm:flex-row justify-end gap-3">
                ...
                <button @click="openEditUser = false" type="button"
