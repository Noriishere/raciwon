...
<template x-teleport="body">
    ...
    <div x-show="openCreateInventory" x-cloak
        ...
        <div @click.stop x-data="{
            ...
            {{-- Header --}}
            <div class="bg-gradient-to-r from-brand-600 to-brand-500 px-6 sm:px-8 py-5 text-white shrink-0">
            ...
            <form action="{{ route('admin.inventory.store') }}" method="POST"
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <div class="border border-slate-200 rounded-3xl overflow-hidden bg-white">
                                ...
                                <div
                                    class="h-36 sm:h-40 bg-gradient-to-br from-orange-50 to-orange-100 flex items-center justify-center">
                                ...
                                <div class="p-5">
                                    ...
                                    <h4 class="font-bold text-lg mt-3 sm:mt-4" x-text="name || 'Preview Bahan'"></h4>

                                    <div class="mt-4 sm:mt-5 space-y-3">

                                        <div class="flex justify-between">
                                            <span class="text-sm text-slate-500">Stok Awal</span>
                                        ...
                                        <div class="flex justify-between">
                                            ...
                                            <span class="font-semibold text-brand-600">
                                                Rp <span x-text="Number(cost || 0).toLocaleString('id-ID')"></span>
                                            </span>
                                        </div>
                ...
                <div class="px-6 sm:px-8 py-4 bg-slate-50 border-t flex justify-end gap-3 shrink-0">
                    ...
                    <button type="submit"
                        class="px-5 py-2.5 sm:py-3 rounded-xl bg-brand-600 text-white hover:bg-brand-700 transition text-sm font-medium shadow-sm flex items-center">
