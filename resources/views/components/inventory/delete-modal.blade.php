...
<template x-teleport="body">
    ...
    <div x-show="openDeleteInventory"
        x-cloak
        ...
        {{-- Backdrop --}}
        <div @click="openDeleteInventory = false"
        ...
        <div @click.stop
            ...
            {{-- Header --}}
            <div class="bg-gradient-to-r from-red-600 to-red-500 px-8 py-6 text-white">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div>
                        ...
                        <p class="text-red-100 mt-1">
                            Tindakan ini dapat memengaruhi data recipe dan costing.
                        </p>

                    </div>

                    <button type="button"
                        @click="openDeleteInventory = false"
            ...
            <div class="p-8">
                ...
                <div class="text-center">
                    ...
                    <p class="mt-3 text-slate-500">
                        ...
                        Bahan baku berikut akan dihapus dari sistem.
                    ...
                    <div class="flex gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-amber-700 mt-1">
                                ...
                                Jika bahan baku masih digunakan oleh Recipe
            ...
            {{-- Footer --}}
            <div class="px-8 py-4 bg-slate-50 border-t flex justify-end gap-3">
