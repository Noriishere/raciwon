...
<template x-teleport="body">
    ...
    <div x-show="openDeleteInventory" x-cloak class="fixed inset-0 z-[99999] flex items-center justify-center p-4 sm:p-6"
        ...
        <div @click.stop
            ...
            {{-- Header --}}
            <div class="bg-gradient-to-r from-red-600 to-red-500 px-6 lg:px-8 py-6 text-white">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <button @click="openDeleteInventory = false"
            ...
            <div class="p-6 lg:p-8">
                ...
                <div class="text-center">
                    ...
                    <p class="mt-3 text-slate-500 max-w-lg mx-auto">
                        ...
                        Data inventaris akan dihapus dari sistem.
                        Pastikan bahan ini sudah tidak digunakan
                        pada recipe atau proses operasional lainnya.
                ...
                {{-- Inventory Info --}}
                <div class="mt-8 border border-slate-200 rounded-3xl p-6">
                    ...
                    <div class="flex gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-amber-700 mt-1">
                                ...
                                Penghapusan bahan dapat memengaruhi
                                Recipe Builder, Food Costing,
                                dan histori penggunaan stok.
            ...
            {{-- Footer --}}
            <div class="px-6 lg:px-8 py-4 bg-slate-50 border-t flex flex-col-reverse sm:flex-row justify-end gap-3">
