...
<template x-teleport="body">
    ...
    <div x-show="openCreateMenu" x-cloak class="fixed inset-0 z-[99999] flex items-center justify-center p-6"
        ...
        {{-- Modal --}}
        {{-- Inisialisasi State Alpine untuk Multi-image Preview --}}
        <div @click.stop 
             x-data="{ 
                imagePreviews: [],
             ...
             class="relative w-full max-w-5xl max-h-[90vh] bg-white rounded-3xl shadow-2xl overflow-hidden"
            ...
            <div class="bg-gradient-to-r from-brand-600 to-brand-500 px-8 py-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-orange-100 mt-1">Tambahkan menu makanan atau minuman baru.</p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="lg:col-span-2">
                            <div class="space-y-5">
                                {{-- Nama --}}
                                <div>
                                    <label class="block mb-2 text-sm font-medium">Nama Menu</label>
                                ...
                                <div class="grid md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <select name="category_id" class="w-full rounded-xl border border-slate-200 px-4 py-3">
                        ...
                        <div>
                            <div class="border border-slate-200 rounded-3xl overflow-hidden">
                                ...
                                <div class="p-4 bg-gradient-to-br from-orange-50 to-orange-100 min-h-52 flex flex-wrap items-center justify-center gap-2">
                                    ...
                                    <template x-for="(src, index) in imagePreviews" :key="index">
                                        <div class="relative w-20 h-20 rounded-xl overflow-hidden border border-white shadow-sm">
                                ...
                                <div class="p-5">
                                    <label class="block w-full py-3 border-2 border-dashed border-slate-300 rounded-xl text-center cursor-pointer hover:border-brand-400 transition">
                                        <i class="fa-solid fa-upload mr-2"></i>
                                        Upload Gambar (Bisa > 1)
                                        
                                        {{-- Ubah name menjadi images[] dan tambahkan atribut multiple --}}
                                        <input type="file" name="images[]" accept="image/*" multiple @change="handleFileChange" class="hidden">
                                    </label>

                                    <span class="inline-block mt-5 px-3 py-1 rounded-full bg-green-100 text-green-700 text-xs font-medium">
                                        Aktif
                                    </span>

                                    <h4 class="font-bold text-lg mt-4">Preview Menu</h4>
                                    <p class="text-slate-500 text-sm mt-1">Nama menu akan tampil di sini.</p>
                                    <p class="mt-4 text-3xl font-bold text-brand-600">Rp 0</p>
                                </div>
                            </div>
                        </div>
