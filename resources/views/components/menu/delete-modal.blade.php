<template x-teleport="body">
    ...
    <div x-show="openDeleteMenu" x-cloak class="fixed inset-0 z-[99999] flex items-center justify-center p-4"
        ...
        <div @click.stop class="relative w-full max-w-md bg-white rounded-3xl shadow-2xl overflow-hidden"
            ...
            <form :action="'{{ route('admin.menus.index') }}/' + selectedMenu.id" method="POST">
                ...
                <div class="p-8 text-center">
                    ...
                    <p class="mt-3 text-slate-500 leading-relaxed">
                        ...
                        <span class="font-semibold text-slate-700" x-text="selectedMenu?.name">
                        </span>
