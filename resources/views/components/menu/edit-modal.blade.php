 ...
 <template x-teleport="body">
     ...
     <div x-show="openEditMenu" x-cloak class="fixed inset-0 z-[99999] flex items-center justify-center p-6"
         ...
         {{-- Modal --}}
         <div @click.stop
             class="relative w-full max-w-5xl mx-auto my-10
                     ...
                     <div class="lg:col-span-2">
                         ...
                         <div class="space-y-3">
                             ...
                             <div>
                                 ...
                                 <textarea rows="6" class="w-full rounded-xl border border-slate-200 px-4 py-3">Nasi goreng dengan topping ayam, telur, dan sayuran segar.</textarea>
