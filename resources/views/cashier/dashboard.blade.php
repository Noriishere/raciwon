...
@section('content')
                ...
                <template x-for="(order,index) in orders" :key="order.id">
                    ...
                    <div
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="px-2 py-1 rounded-full text-xs h-fit"
                                :class="
    ...
    @include('components.cashier.order-modal')
    @push('scripts')
                            ...
                            await fetch(
                                '/api/v1/orders',
                                {
                                    ...
                                    body: JSON.stringify({
                                        ...
                                        table_id:
                                            this.newOrder.table_id,

                                        items:
                                            this.newOrder.items.map(
                                                item => ({
