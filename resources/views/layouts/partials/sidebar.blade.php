<aside :class="sidebarOpen ? 'w-72' : 'w-20'"
    ...
    : 'hover:bg-brand-600 text-orange-50' }}">
        ...
        <a href="{{ route('admin.inventory.index') }}" :class="sidebarOpen ? 'justify-start gap-3' : 'justify-center'" class="flex items-center px-4 py-3 rounded-xl transition
    ...
    : 'hover:bg-brand-600 text-orange-50' }}">
        ...
        <a href="{{ route('admin.reports') }}" :class="sidebarOpen ? 'justify-start gap-3' : 'justify-center'" class="flex items-center px-4 py-3 rounded-xl transition
    ...
    : 'hover:bg-brand-600 text-orange-50' }}">
        ...
        <a href="{{ route('admin.analytics') }}" :class="sidebarOpen ? 'justify-start gap-3' : 'justify-center'" class="flex items-center px-4 py-3 rounded-xl transition
...
<template x-teleport="body">
    ...
    <div x-show="mobileMenuOpen" x-cloak class="fixed inset-0 z-[99999] lg:hidden">

        {{-- Backdrop --}}
        <div @click="mobileMenuOpen = false" class="absolute inset-0 bg-slate-900/60 backdrop-blur-sm"
        ...
        {{-- Sidebar --}}
        <aside class="absolute left-0 top-0 h-full w-72 bg-brand-700 text-white flex flex-col shadow-2xl"
            ...
            <div class="h-20 px-5 flex items-center justify-between border-b border-white/10">
                ...
                <button @click="mobileMenuOpen = false" class="w-10 h-10 rounded-xl hover:bg-brand-600 transition">
    ...
    : 'hover:bg-brand-600 text-orange-50' }}">
                ...
                <a href="{{ route('admin.reports') }}" :class="sidebarOpen ? 'justify-start gap-3' : 'justify-center'"
                    class="flex items-center px-4 py-3 rounded-xl transition
            {{ request()->routeIs('admin.reports')
    ? 'bg-white text-brand-700 font-semibold shadow-md'
    : 'hover:bg-brand-600 text-orange-50' }}">
                ...
                <a href="{{ route('admin.analytics') }}" :class="sidebarOpen ? 'justify-start gap-3' : 'justify-center'"
                    class="flex items-center px-4 py-3 rounded-xl transition
            {{ request()->routeIs('admin.reports')
    ? 'bg-white text-brand-700 font-semibold shadow-md'
    : 'hover:bg-brand-600 text-orange-50' }}">
